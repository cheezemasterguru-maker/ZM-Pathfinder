window.ZM_SHAFT_DATA = {
  MainDeep: {
    ...
    "DEEP 4": {
      "Chamber 1": [
        ...
        { shaftType: "Cobalt", level: 40, auto: "U-13" },
        { shaftType: "Elendir", level: 42, auto: "C-14" }
      ],

      "Chamber 2": [
        { shaftType: "Lapis Lazuli", level: 47, auto: "U-12" },
        { shaftType: "Peridot", level: 50, auto: "U-12" },
        { shaftType: "Tanzanite", level: 53, auto: "C-14" }
      ],

      "Chamber 3": [
        { shaftType: "Cyril", level: 57, auto: "U-15" },
        { shaftType: "Vulcanite", level: 67, auto: "C-14" }
      ]
    }
  },
  ...
  "Chamber 3": [
    ...
    { shaftType: "Elendir", level: 26, auto: 6 },
    ...
    "Easter Egg Hunt": {
      ...
      "Mine 3": {
        "Chamber 1": [
          ...
          { shaftType: "Quartz", level: 7, auto: 7 },
          { shaftType: "Cobalt", level: 10, auto: 8 }
        ],
        "Chamber 2": [
          { shaftType: "Amber", level: 8, auto: 8 },
          { shaftType: "Ametrine", level: 13, auto: 7 },
