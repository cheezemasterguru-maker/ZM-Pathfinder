(function () {
  console.log("ZM Solver V7.7-standard-grid-only-red-locked loaded");

  const SOLVER_VERSION = "V7.7-standard-grid-only-red-locked";
...
` +
        `solver_status: solved
` +
        `standard_source: grid_only_no_tile_meta
` +
